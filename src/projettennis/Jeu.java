...
public class Jeu {
    ...
    public static void AffichageScorePoint(ArrayList<Match> ListMatch, int pointjoueur1, int pointjoueur2, int n) {
        ...
        switch (pointjoueur1) {
            ...
            case 5:
                score1 = "GAGNE";
                System.out.println(" Victoire du joueur 1 : " + ListMatch.get(n-1).Joueur1.nomNaissance);
                break;
        ...
        switch (pointjoueur2) {
            ...
            case 5:
                score2 = "GAGNE";
                System.out.println(" Victoire du joueur 2 : " + ListMatch.get(n-1).Joueur2.nomNaissance);
                break;

        }
        System.out.println("\n");
        System.out.println("    Point " + ListMatch.get(n-1).Joueur1.nomNaissance + " - " + ListMatch.get(n-1).Joueur2.nomNaissance + "  :  " + score1 + " - " + score2);
        System.out.println("\n");
    }
}
