                    ...
                    while (menu3 == 0) {
                        ...
                        while (str5.equals("oui")) {
                            ...
                            if (ListMatch.get(IntMatch - 1).Resultat == 1) {
                                ...
                                ListMatch = Match.JouerM(ListMatch, IntMatch, ObjTournoi, auto);
                        ...
                        while (n <= ListMatch.size()) {
                            if (ListMatch.get(n - 1).Resultat == 0) {
                                ...
                                ListMatch = Match.JouerM(ListMatch, n, ObjTournoi, auto);
                            }
                        ...
                        ObjTournoi.nbTour++;
                        ListQualif = Tournoi.ListeQualif(ListMatch, ObjTournoi.nbTour);
                        ListMatch = Tournoi.CompoMatch(ListQualif, ListArbitre, ObjTournoi.nbTour);           //ListJoueur au lieu de ListQualif car tous qualifié et modificatioh de ListQualif dans l'ordre Random
